...
namespace HTC.UnityPlugin.Multimedia
{
    public class NativeClass
    {
        ...
        public const string NATIVE_LIBRARY_NAME = "ViveMediaDecoder";
    ...
    public class ViveMediaDecoder : MonoBehaviour
    {
        ...
        private NativeClass.DecoderState decoderState = NativeClass.DecoderState.NOT_INITIALIZED;
        ...
        {
            var texMaterial = GetComponent<MeshRenderer>().material;
